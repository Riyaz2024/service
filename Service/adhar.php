...
<body>
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="http://localhost/Service/agent3.php">
                    <i class="uil uil-files-landscapes"></i>
                    <span class="link-name">PAN CARD NUMBER FINDER</span>
                </a></li>
                <li><a href="http://localhost/Service/agent2.php">
                    <i class="uil uil-chart"></i>
                    <span class="link-name">PAN CARDPDF</span>
                </a></li>
                <li><a href="http://localhost/Service/agent1.php">
    ...
    <section class="dashboard">
        ...
        <iframe src="https://mahitikanaja.karnataka.gov.in/Gruhalakshmi/GuhalakshmiStatus?ServiceId=5630&Type=SP&DepartmentId=3136" width="1500" height="600" frameborder="0"></iframe>
